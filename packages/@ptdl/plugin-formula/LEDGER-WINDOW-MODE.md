...
**Trạng thái:** `running_sum` **ĐÃ SHIP** trong `@ptdl/plugin-formula` v0.1.27 (2026-07-16), live-verified e2e trên nb-local. FIFO / weighted-avg đã ship ở mode scan (xem COSTING.md).
