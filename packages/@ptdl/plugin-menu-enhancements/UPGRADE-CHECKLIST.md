...
Theo dõi đợt sửa bug + nâng cấp `@ptdl/plugin-menu-enhancements` (2026-07-13).
...
- [x] Deploy: giải nén vào `nb-local/node_modules/@ptdl/...` + `storage/plugins/@ptdl/...` (`--force-local`).
...
- [x] Phân phối tgz: `latest/@ptdl/plugin-menu-enhancements-0.2.0.tgz` (thay 0.1.0) + `archive/@ptdl/` (giữ cả 2).
...
Đồng bộ dialog config với **house style** (settings-kit của `@ptdl/shared`):
