...
// antd Tag palette (names) + hex map — now unified in @ptdl/shared on the primary-6 palette.
export { TAG_COLORS, TAG_HEX } from '@ptdl/shared';

import { TAG_HEX as _TAG_HEX } from '@ptdl/shared';
