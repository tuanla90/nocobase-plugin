...
// setStatusFlowIconRegistry() in load(). We render lucide-* keys (provided by
// @ptdl/plugin-custom-icons) and gracefully fall back to the always-present antd keys.
let IconComp: any = null;
let iconsMap: Map<string, any> | null = null;

export function setStatusFlowIconRegistry(deps: { Icon: any; icons?: Map<string, any> }) {
