// Standard NocoBase i18n routing for @ptdl/plugin-status-flow (replaces the old bespoke
...
//
// Two translators, mirroring the @ptdl/plugin-custom-header house pattern:
...
export const NS = '@ptdl/plugin-status-flow/client';
