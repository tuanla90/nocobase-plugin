/**
 * Quick View — classic (`/admin`) lane: intentionally a no-op. The tool builds a `/v/` FlowModel page
...
export class PluginQuickViewClient extends Plugin {
  async load() {
    // no classic-lane UI — see ../client-v2 for the real implementation
  }
}

export default PluginQuickViewClient;
