# @ptdl/plugin-quick-view — "Tạo trang nhanh" / Quick Create Page View

One action → a ready-to-use page. Pick a **collection** and a **list of columns**; Quick View builds a
