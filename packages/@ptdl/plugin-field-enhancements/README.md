...
**Group:** Fields · **Runs on:** /admin (classic) + /v/ (modern) · **Version:** 0.2.12
...
components end-to-end. Icons come from the shared registry (`@ptdl/shared` → `IconByKey` / `RegistryIconPicker`); with
`@ptdl/plugin-custom-icons` installed you get the full **Lucide** set, otherwise the built-in Ant Design icons.
