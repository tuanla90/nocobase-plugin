 ...
 * So with @ptdl/plugin-custom-icons installed you get the full lucide set; without it, the
 * picker still works and falls back to the built-in Ant Design icons. No lucide bundled.
 *
 * Icon registry + picker come from @ptdl/shared: the host Icon component + icons Map are
