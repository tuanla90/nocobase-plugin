...
**Group:** UI (search) · **Runs on:** /admin (classic) + /v/ (modern) · **Version:** 0.9.6
...
when the server isn't reachable. Both template kinds use double-brace `{{field}}` tokens (via `@ptdl/shared`'s
