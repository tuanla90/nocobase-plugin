...
// now lives in @ptdl/shared as `interpolate(tpl, row, { filters: true })` — the canonical superset
// (extra date tokens MMMM/MMM/D/M/hh/A/a, compact K/M/B numbers). Standard syntax is DOUBLE-brace
// `{{field}}` (matches link tokens + the other @ptdl plugins); legacy single-brace `{field}` still
