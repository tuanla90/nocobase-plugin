/**
 * @ptdl/plugin-ai-column — i18n plumbing shared by every lane/module of the plugin.
 *
 * Scheme (identical to @ptdl/plugin-conditional-format): the VIETNAMESE user-facing string IS the
...
export const NS = '@ptdl/plugin-ai-column/client';
