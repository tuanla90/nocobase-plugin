...
/**
 * @ptdl/plugin-ai-column — "Bulk AI Extract": the image-reading sibling of Bulk AI Generate
...
export function registerBulkExtract({ flowEngine, ActionModel, ActionSceneEnum, api, tExpr }: BulkExtractDeps) {
  ...
  try {
    flowEngine.flowSettings?.registerComponents?.({ PtdlBulkSourceAttachment });
  } catch (e) {
    // eslint-disable-next-line no-console
