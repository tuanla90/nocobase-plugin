...
/**
 * @ptdl/plugin-ai-column — "Bulk AI Image" / "Bulk AI Voice": the media-generation siblings of Bulk
...
function registerBulkMedia({ flowEngine, ActionModel, ActionSceneEnum, api, tExpr }: BulkMediaDeps, spec: BulkMediaSpec) {
  ...
  try {
    flowEngine.flowSettings?.registerComponents?.({ PtdlBulkTargetAttachment, ...spec.components });
  } catch (e) {
    // eslint-disable-next-line no-console
