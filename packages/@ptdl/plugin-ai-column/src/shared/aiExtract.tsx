...
/**
 * @ptdl/plugin-ai-column — "AI Extract": read an ATTACHMENT field (image/PDF, e.g. an ID card
  ...
  return {
    ...
    steps: {
      ai: {
        ...
        defaultParams: { aiService: '', aiModel: '', aiSystem: '', aiPrompt: '', aiMapping: [], aiTrigger: [], aiGate: {} },
