# @ptdl admin config-page design rules

House rules for any `@ptdl` plugin **Settings page** so they look native to NocoBase and consistent with each
...
The reference is any core/@ptdl settings page (e.g. `change-log`, `print-template/pdf-service`):
