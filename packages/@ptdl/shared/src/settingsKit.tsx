...
// ============================================================================
// (B0) Settings-PAGE container (page-level chrome, used by every @ptdl config page)
// ============================================================================

/**
 * The standard settings-PAGE frame: a white, bordered, radius-8 card that every @ptdl config page sits
