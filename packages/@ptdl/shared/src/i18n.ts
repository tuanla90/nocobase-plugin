/**
 * Runtime i18n for @ptdl/shared's own render strings (field-picker labels, etc.).
 *
 * @ptdl/shared is BUNDLED into each plugin (not a runtime dep) and has NO i18n context of its own,
 ...
 */
export const SHARED_NS = '@ptdl/shared';
