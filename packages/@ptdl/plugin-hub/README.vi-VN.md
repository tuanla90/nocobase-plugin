...
> Cài **một plugin duy nhất**, rồi từ đó **cài và cập nhật mọi plugin @ptdl khác** — không cần upload
...
1. **Nguồn** — ô **Manifest URL** (mặc định = `latest/index.json` của repo @ptdl công khai). Manifest là một
