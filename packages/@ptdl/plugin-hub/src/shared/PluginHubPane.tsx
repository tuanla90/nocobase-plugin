...
import { ConfigContainer, SettingCard, Hint } from '@ptdl/shared';
    ...
    <ConfigContainer maxWidth={1180}>
      <div style={{ marginBottom: 14 }}>
        ...
        <Paragraph type="secondary" style={{ margin: '4px 0 0' }}>
          {t('Install and update your @ptdl plugins from one manifest — no browser upload. The weekly check only notifies; nothing is auto-applied.')}
        </Paragraph>
      </div>
      ...
      <SettingCard style={{ marginBottom: 14 }}>
        ...
        <Space direction="vertical" style={{ width: '100%' }} size={10}>
          <div>
            ...
            <div style={{ marginTop: 4 }}><Hint tip={t('A JSON listing { packageName, version, url } per plugin. Default = the public @ptdl repo.')} /> <Text type="secondary" style={{ fontSize: 12 }}>{t('A manifest that lists each plugin + its download URL.')}</Text></div>
          </div>
          <Space>
