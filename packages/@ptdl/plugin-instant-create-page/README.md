...
**Group:** Blocks · **Runs on:** **/v/** (modern) only — the **/admin** (classic) client does not have this tool · **Version:** 0.1.0
...
- If you've installed `@ptdl/plugin-enhanced-table-block`, the form shows an extra **"Table type"** box.
