// See client-v2 note: entry import so @formily/react (pulled by @tuanla90/shared index) is
...
export class PluginPrintTemplateClient extends Plugin {
  async load() {
    ...
    // become a tab bar (same as other @tuanla90 plugins split their settings).
