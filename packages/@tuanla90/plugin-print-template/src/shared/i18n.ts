// i18n for @tuanla90/plugin-print-template — VN-string-as-key scheme (mirrors
// @tuanla90/plugin-conditional-format). Vietnamese IS the source AND the i18n key; only
...
export const NS = '@tuanla90/plugin-print-template/client';
