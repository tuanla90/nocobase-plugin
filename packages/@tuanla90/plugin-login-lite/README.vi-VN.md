...
**Nhóm:** Xác thực & Giao diện (Auth/UI) · **Chạy trên:** /admin (classic) + /v/ (modern) · **Phiên bản:** 2.3.3
...
Các helper thuần (không phụ thuộc framework) nằm trong `@tuanla90/shared` (`loginKit`) và được đóng gói kèm plugin. Song-license
