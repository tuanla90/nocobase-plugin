...
const NS = '@tuanla90/plugin-instant-create-page/client';

export class PluginInstantCreatePageClientV2 extends Plugin {
  async load() {
    // This plugin renders only plain antd (no @tuanla90/shared UI), so it needs no SHARED_NS wiring — and
    // importing @tuanla90/shared at all would pull settingsKit's @formily/react into the bundle.
    try {
