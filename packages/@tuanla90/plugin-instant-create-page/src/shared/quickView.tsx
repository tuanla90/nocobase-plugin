 ...
 *  site without @tuanla90/plugin-status-flow simply doesn't get the button. */
...
/** Find the collection's @tuanla90/plugin-status-flow field name (if any), so the page can offer a
