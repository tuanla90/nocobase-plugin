...
// Fetch a collection's fields (collections:get + appends fields). Inlined (was @tuanla90/shared's getFields)
// so this plugin imports NOTHING from @tuanla90/shared — that import pulls shared's whole index, incl.
...
// Column options for the picker. Unlike @tuanla90/shared's buildColumnOptions (which maps a belongsTo to its
