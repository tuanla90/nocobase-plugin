...
**Nhóm:** Khối & Trang (Blocks) · **Chạy trên:** chỉ **/v/** (modern) — giao diện **/admin** (classic) không có công cụ này · **Phiên bản:** 0.1.8
...
- Nếu bạn đã cài `@tuanla90/plugin-enhanced-table-block`, biểu mẫu sẽ hiện thêm ô **“Loại bảng”**.
