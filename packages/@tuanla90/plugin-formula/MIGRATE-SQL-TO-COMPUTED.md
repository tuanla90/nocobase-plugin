...
> của `@tuanla90/plugin-formula`. Rút ra từ một hệ logistics thật (5 workflow, ~35 phép cập-nhật-cột).
...
| Tạo dòng mới theo quy tắc (1 cha → N con, backfill đầu kỳ) | **Line Generator** | `@tuanla90/plugin-line-generator` |
