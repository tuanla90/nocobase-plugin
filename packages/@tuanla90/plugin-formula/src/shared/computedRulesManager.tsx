...
import { SettingCard, SettingRow, Hint, FieldPickerCascader, getCaretElement, insertAtCaret, getFields } from '@tuanla90/shared';
 ...
 * filter). Styled with the @tuanla90 settings-kit (theme-aware CSS vars). `api` is provided per-lane.
 *
