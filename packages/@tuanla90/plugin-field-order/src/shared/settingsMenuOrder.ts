 ...
 * None of the @tuanla90 settings pages set a sort, so they land in registration order.
 *
 * We stamp an explicit ascending `sort` onto the known @tuanla90 menu keys — without
 ...
 *
 * Folded into @tuanla90/plugin-field-order (the "ordering" plugin) by request.
