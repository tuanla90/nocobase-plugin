...
// This plugin now renders antd components via @tuanla90/shared (FieldPickerCascader). A DIRECT antd
// import makes nocobase-build externalize `antd` for this client bundle; without a source-level
// antd import, rspack tries to bundle antd from @tuanla90/shared and fails on the framework stub.
import 'antd';
import { useFlowSettingsContext } from '@nocobase/flow-engine';
import { theme } from 'antd';
import { renderCustomHtml, HELPERS_REF, SAMPLE_DATA, DEFAULT_JS, getCachedData } from './render';
import { PRESETS } from './presets';
import { FieldPickerCascader, getCaretElement, insertAtCaret, AiCodegenButton, st } from '@tuanla90/shared';
import { t } from './i18n';
