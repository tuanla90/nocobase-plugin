...
import { ColorField, registerSettingsKit, rx, fi, ConditionRow, opNeedsNoValue, onLiveRefresh, ColumnSelect } from '@tuanla90/shared';
import type { CondMeta } from '@tuanla90/shared';
import { Play, Plus, ArrowLeft, X } from 'lucide-react';

/**
 * @tuanla90/plugin-menu-badge — show a live COUNT badge on a left-sidebar menu item (e.g. "12" pending
 ...
 *    change). Same pattern as @tuanla90/plugin-menu-sections.
...
function patchRender(proto: any) {
  ...
  proto.render = function (this: any) {
    ...
    try {
      ...
      // Don't badge items converted to a divider / group label by @tuanla90/plugin-menu-sections.
