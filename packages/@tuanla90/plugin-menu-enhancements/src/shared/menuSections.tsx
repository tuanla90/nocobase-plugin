...
import { ColorField, registerSettingsKit, rx, fi, livePreview, previewField, SEG_PROPS, SegmentedGroup } from '@tuanla90/shared';

/**
 * @tuanla90/plugin-menu-sections — turn any left-sidebar menu item into a NON-CLICKABLE
