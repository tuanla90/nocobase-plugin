...
EnhancedTableBlockModel.registerFlow({
  ...
  sort: 600,
  title: tExpr('Enhanced table settings', { ns: ['@tuanla90/plugin-enhanced-table-block', 'client'] }),
  steps: {
    summaryConfig: {
      title: tExpr('Summary row settings', { ns: ['@tuanla90/plugin-enhanced-table-block', 'client'] }),
      uiSchema: (ctx) => {
...
EnhancedTableBlockModel.define({
  label: tExpr('Enhanced Table', { ns: ['@tuanla90/plugin-enhanced-table-block', 'client'] }),
  group: tExpr('Content'),
  searchable: true,
