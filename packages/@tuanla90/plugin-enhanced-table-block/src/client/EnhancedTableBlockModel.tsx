...
import { escapeHtml, aggSum, aggAvg } from '@tuanla90/shared';
...
// escapeHtml now comes from '@tuanla90/shared' (imported above) — byte-equivalent to the former local
...
export const EnhancedTableWrapper = observer(({ model, children }: { model?: any; children: React.ReactNode }) => {
  ...
  const { t } = useTranslation(['@tuanla90/plugin-enhanced-table-block/client', 'client'], { nsMode: 'fallback' });
  ...
  // Formula column from @tuanla90/plugin-formula. Keyed '__vcol__<uid>'; value = the column model.
  ...
  useEffect(() => {
    const tLabels: Record<string, string> = {
      sum: t('Sum', { ns: '@tuanla90/plugin-enhanced-table-block/client' }),
      avg: t('Average', { ns: '@tuanla90/plugin-enhanced-table-block/client' }),
      count: t('Count', { ns: '@tuanla90/plugin-enhanced-table-block/client' }),
      countDistinct: t('Count distinct', { ns: '@tuanla90/plugin-enhanced-table-block/client' }),
      max: t('Max', { ns: '@tuanla90/plugin-enhanced-table-block/client' }),
      min: t('Min', { ns: '@tuanla90/plugin-enhanced-table-block/client' }),
    };
        ...
        if (matchedIndex) {
          ...
          if (selResult !== null) {
            ...
            const selLabel = t('{{num}} selected', {
              ns: '@tuanla90/plugin-enhanced-table-block/client',
              num: selectedTrs.length,
            });
            const allLabel = t('All', { ns: '@tuanla90/plugin-enhanced-table-block/client' });
      ...
      {selectionStats && mousePos && (
        ...
        >
          ...
          <div style={{ display: 'flex', justifyContent: 'space-between', gap: '16px' }}>
            <span>{t('Sum', { ns: '@tuanla90/plugin-enhanced-table-block/client' })}：</span>
            <strong>{formatStat(selectionStats.sum)}</strong>
          </div>
          <div style={{ display: 'flex', justifyContent: 'space-between', gap: '16px' }}>
            <span>{t('Max', { ns: '@tuanla90/plugin-enhanced-table-block/client' })}：</span>
            <strong>{formatStat(selectionStats.max)}</strong>
          </div>
          <div style={{ display: 'flex', justifyContent: 'space-between', gap: '16px' }}>
            <span>{t('Min', { ns: '@tuanla90/plugin-enhanced-table-block/client' })}：</span>
            <strong>{formatStat(selectionStats.min)}</strong>
          </div>
          <div style={{ display: 'flex', justifyContent: 'space-between', gap: '16px' }}>
            <span>{t('Average', { ns: '@tuanla90/plugin-enhanced-table-block/client' })}：</span>
...
EnhancedTableBlockModel.registerFlow({
  ...
  sort: 600,
  title: `{{t("Enhanced table settings", { ns: "@tuanla90/plugin-enhanced-table-block/client" })}}`,
  steps: {
    summaryConfig: {
      title: `{{t("Summary row settings", { ns: "@tuanla90/plugin-enhanced-table-block/client" })}}`,
      uiSchema: (ctx) => {
        ...
        const countOptions = [
          { label: `{{t("Count", { ns: "@tuanla90/plugin-enhanced-table-block/client" })}}`, value: 'count' },
          { label: `{{t("Count distinct", { ns: "@tuanla90/plugin-enhanced-table-block/client" })}}`, value: 'countDistinct' },
        ];
        const numericOptions = [
          { label: `{{t("Sum", { ns: "@tuanla90/plugin-enhanced-table-block/client" })}}`, value: 'sum' },
          { label: `{{t("Average", { ns: "@tuanla90/plugin-enhanced-table-block/client" })}}`, value: 'avg' },
          ...countOptions,
          { label: `{{t("Min", { ns: "@tuanla90/plugin-enhanced-table-block/client" })}}`, value: 'min' },
          { label: `{{t("Max", { ns: "@tuanla90/plugin-enhanced-table-block/client" })}}`, value: 'max' },
        ];
            ...
            acc[col.value] = {
              ...
              properties: {
                type: {
                  ...
                  'x-component-props': {
                    allowClear: true,
                    placeholder: `{{t("Select aggregation type", { ns: "@tuanla90/plugin-enhanced-table-block/client" })}}`,
                ...
                label: {
                  ...
                  'x-component-props': {
                    allowClear: true,
                    placeholder: `{{t("Custom label", { ns: "@tuanla90/plugin-enhanced-table-block/client" })}}`,
                  },
                },
              },
            };
          ...
          settingsTabs: {
            ...
            properties: {
              tabColumns: {
                ...
                'x-component-props': {
                  tab: `{{t("Summary row settings", { ns: "@tuanla90/plugin-enhanced-table-block/client" })}}`,
                },
                properties: {
                  summaryConfig: {
                    type: 'object',
              ...
              tabStyle: {
                ...
                'x-component': 'FormTab.TabPane',
                'x-component-props': {
                  tab: `{{t("Summary row style", { ns: "@tuanla90/plugin-enhanced-table-block/client" })}}`,
                },
                properties: {
                  summaryStyle: {
                    type: 'object',
                    ...
                    properties: {
                      position: {
                        type: 'string',
                        title: `{{t("Summary row position", { ns: "@tuanla90/plugin-enhanced-table-block/client" })}}`,
                        ...
                        'x-component-props': {
                          options: [
                            {
                              label: `{{t("Bottom (default)", { ns: "@tuanla90/plugin-enhanced-table-block/client" })}}`,
                              value: 'bottom',
                            },
                            {
                              label: `{{t("Top, sticky below header", { ns: "@tuanla90/plugin-enhanced-table-block/client" })}}`,
                              value: 'top',
                            },
                          ],
                        },
                      ...
                      showLabel: {
                        type: 'boolean',
                        title: `{{t("Show label", { ns: "@tuanla90/plugin-enhanced-table-block/client" })}}`,
                      ...
                      valueColor: {
                        type: 'string',
                        title: `{{t("Value text color", { ns: "@tuanla90/plugin-enhanced-table-block/client" })}}`,
                      ...
                      labelColor: {
                        type: 'string',
                        title: `{{t("Label text color", { ns: "@tuanla90/plugin-enhanced-table-block/client" })}}`,
                      ...
                      backgroundColor: {
                        type: 'string',
                        title: `{{t("Background color", { ns: "@tuanla90/plugin-enhanced-table-block/client" })}}`,
                      ...
                      valueFontWeight: {
                        type: 'string',
                        title: `{{t("Value font weight", { ns: "@tuanla90/plugin-enhanced-table-block/client" })}}`,
                        ...
                        'x-component-props': {
                          allowClear: true,
                          options: [
                            { label: `{{t("Bold", { ns: "@tuanla90/plugin-enhanced-table-block/client" })}}`, value: 'bold' },
                            { label: `{{t("Normal", { ns: "@tuanla90/plugin-enhanced-table-block/client" })}}`, value: 'normal' },
                          ],
                        },
                      },
                      valueFontSize: {
                        type: 'string',
                        title: `{{t("Value font size (px)", { ns: "@tuanla90/plugin-enhanced-table-block/client" })}}`,
...
EnhancedTableBlockModel.registerFlow({
  ...
  sort: 610,
  title: `{{t("Responsive (mobile cards)", { ns: "@tuanla90/plugin-enhanced-table-block/client" })}}`,
  steps: {
    settings: {
      title: `{{t("Responsive (mobile cards)", { ns: "@tuanla90/plugin-enhanced-table-block/client" })}}`,
      uiSchema: {
        responsiveCard: {
          type: 'boolean',
          title: `{{t("Show as cards on narrow screens", { ns: "@tuanla90/plugin-enhanced-table-block/client" })}}`,
          'x-decorator': 'FormItem',
          'x-component': 'EtRespSwitch',
        },
        responsiveBreakpoint: {
          type: 'number',
          title: `{{t("Switch to cards below width", { ns: "@tuanla90/plugin-enhanced-table-block/client" })}}`,
          'x-decorator': 'FormItem',
...
EnhancedTableBlockModel.define({
  label: `{{t("Enhanced Table", { ns: "@tuanla90/plugin-enhanced-table-block/client" })}}`,
  group: `{{t("Content", { ns: "@tuanla90/plugin-enhanced-table-block/client" })}}`,
  searchable: true,
  searchPlaceholder: `{{t("Search", { ns: "@tuanla90/plugin-enhanced-table-block/client" })}}`,
  createModelOptions: () => ({
