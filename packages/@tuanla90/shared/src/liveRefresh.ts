/**
 * Reusable server→client "live refresh" over NocoBase's app WebSocket. Shared across @tuanla90 plugins
...
/**
 * Subscribe to BOTH @tuanla90 refresh signals (computed-settled + data-changed) at once. `handler` gets the
