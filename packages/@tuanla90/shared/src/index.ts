...
export {
  ...
  SettingsGrid, fieldItem, fi, rx, visibleWhen, ResetButton, PreviewBox, CollapsibleSection, registerFlowComponentsOnce,
...
// in load() so @tuanla90/shared's own labels (field-picker button, empty state) are bilingual per lane.
export { SHARED_NS, setSharedT, sharedEnUS, st } from './i18n';
// AI "viết hộ" button (client). The SERVER codegen helper lives at the `@tuanla90/shared/ai-server`
