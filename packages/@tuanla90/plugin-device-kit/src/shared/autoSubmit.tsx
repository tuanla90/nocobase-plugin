...
import { SettingsGrid, fi, CollapsibleSection, registerFlowComponentsOnce } from '@tuanla90/shared';
...
export function registerAutoSubmit(deps: { flowEngine: any; flowSettings?: any; lane: string }) {
  ...
  if (flowSettings?.registerComponents) {
    try { registerFlowComponentsOnce(flowSettings, { ADK_Switch, ADK_Field, ADK_Hint, ADK_Grid: SettingsGrid, ADK_Section: CollapsibleSection }); }
