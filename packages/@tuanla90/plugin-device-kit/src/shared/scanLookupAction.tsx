...
import { SettingsGrid, fi, ResetButton, CollapsibleSection, SEG_PROPS, registerFlowComponentsOnce } from '@tuanla90/shared';
...
export function registerScanLookupAction(deps: { flowEngine: any; flowSettings?: any; lane: string }) {
  ...
  if (flowSettings?.registerComponents) {
    try { registerFlowComponentsOnce(flowSettings, { SL_Grid: SettingsGrid, SL_Field, SL_Switch, SL_Text, SL_Outcome, SL_Reset: ResetButton, SL_Section: CollapsibleSection }); }
