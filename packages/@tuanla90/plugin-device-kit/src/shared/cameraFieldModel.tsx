...
import { SettingsGrid, fi, ResetButton, CollapsibleSection, SEG_PROPS, SegmentedGroup, registerFlowComponentsOnce } from '@tuanla90/shared';
...
function metaFieldOptions(model: any): any[] {
  ...
  const selfName = resolveCf(model)?.name;
