...
import { SettingsGrid, fi, ResetButton, registerFlowComponentsOnce } from '@tuanla90/shared';
...
export function registerAudioFieldModel(deps: { flowEngine: any; flowSettings?: any; lane: string }) {
  ...
  if (flowSettings?.registerComponents) {
    try { registerFlowComponentsOnce(flowSettings, { AU_Grid: SettingsGrid, AU_Sec, AU_Reset: ResetButton }); }
