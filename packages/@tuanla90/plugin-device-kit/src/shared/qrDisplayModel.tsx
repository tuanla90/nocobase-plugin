...
import { SettingsGrid, fi, ResetButton, SEG_PROPS, registerFlowComponentsOnce } from '@tuanla90/shared';
...
export function registerQrDisplayModel(deps: { flowEngine: any; flowSettings?: any; Base: any }) {
  ...
  if (flowSettings?.registerComponents) {
    try { registerFlowComponentsOnce(flowSettings, { Q_Grid: SettingsGrid, Q_Size, Q_Level, Q_Text, Q_Reset: ResetButton }); }
