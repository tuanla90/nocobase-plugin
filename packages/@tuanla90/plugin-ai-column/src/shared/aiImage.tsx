...
/**
 * @tuanla90/plugin-ai-column — media GENERATION into an attachment field (image + voice). Mirror-image
...
function registerMediaGen(
  ...
  try {
    registerFlowComponentsOnce(flowEngine, opts.settingsComponents);
  } catch (e) {
    // eslint-disable-next-line no-console
  ...
  return {
    ...
    steps: {
      ai: {
        ...
        defaultParams: { aiService: '', aiImageModel: '', aiImageSource: '', aiPrompt: '', aiTrigger: [], aiGate: {}, aiHint: '' },
