...
/**
 * @tuanla90/plugin-ai-column — "Bulk AI Extract-rows": a COLLECTION-scene table action that runs AI
...
export function registerBulkExtractRows({ flowEngine, ActionModel, ActionSceneEnum, api, tExpr }: BulkExtractRowsDeps) {
  ...
  try {
    registerFlowComponentsOnce(flowEngine, { PtdlBulkRowsSource, FormTab, 'FormTab.TabPane': FormTab.TabPane });
  } catch (e) {
    // eslint-disable-next-line no-console
