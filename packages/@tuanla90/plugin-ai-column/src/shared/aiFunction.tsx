...
import { getFields, visibleWhen } from '@tuanla90/shared';
...
/**
 * @tuanla90/plugin-ai-column — "AI Function": ONE record-scoped action button (RecordActionModel, on a
...
export function registerAiFunction({ flowEngine, RecordActionModel, FormActionModel, ActionSceneEnum, api, tExpr }: AiFunctionDeps) {
  ...
  try {
    registerFlowComponentsOnce(flowEngine, { PtdlAiJobSelect, FormTab, 'FormTab.TabPane': FormTab.TabPane });
  } catch (e) {
