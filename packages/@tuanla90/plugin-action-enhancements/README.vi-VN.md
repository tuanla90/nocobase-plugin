...
**Nhóm:** Giao diện · Nút thao tác (Actions/UI)  ·  **Chạy trên:** /admin (classic) + /v/ (modern)  ·  **Phiên bản:** 0.1.2
...
(`addFilterGroup` → `setPage(1)` → `refresh()`). Song ngữ Anh/Việt, dùng chung `@tuanla90/shared`.
