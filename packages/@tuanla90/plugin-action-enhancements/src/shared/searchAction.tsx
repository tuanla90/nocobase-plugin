...
import { ColorField, SettingsGrid, buildFieldCascaderOptions, rx, SegmentedGroup, registerFlowComponentsOnce } from '@tuanla90/shared';
...
export function registerSearchAction(deps: { flowEngine: any; tExpr: (s: string, o?: any) => any; lane: string }) {
  ...
  const bind = (attempt = 0) => {
    ...
    try {
      ...
      try {
        registerFlowComponentsOnce(flowEngine.flowSettings, { PtdlSearchPreview: SearchBarPreview, PtdlSearchGrid: SettingsGrid });
      } catch (e) {
        /* preview optional */
      }
