...
import { ColorField, SettingsGrid, registerFlowComponentsOnce } from '@tuanla90/shared';
...
export function patchActionColor(deps: { flowEngine: any; tExpr: (s: string, o?: any) => any; lane: string }) {
  ...
  const bind = (attempt = 0) => {
    ...
    try {
      registerFlowComponentsOnce(flowEngine.flowSettings, { PtdlBtnColourPreview: ButtonColourPreview, PtdlBtnGrid: SettingsGrid });
    } catch (e) {
