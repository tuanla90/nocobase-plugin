/**
 * @tuanla90/plugin-formula — shared formula engine.
 *
...
// escapeHtml is INLINED (not imported from '@tuanla90/shared') so this engine has ZERO package imports —
...
// import like '@tuanla90/shared/format' would be MISSING at runtime. Byte-equivalent to @tuanla90/shared's.
...
export const CUSTOM_FNS: Record<string, (...a: any[]) => any> = { FILTER, filter: FILTER, SELECT: FILTER, select: FILTER, __FILTER_ROWS };
