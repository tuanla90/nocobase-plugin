 ...
 * @tuanla90/plugin-custom-icons is installed) with colour / size / optional background shape / optional name label.
...
export function registerIconFieldModel(deps: {
  ...
  if (flowSettings?.registerComponents) {
    try {
      registerFlowComponentsOnce(flowSettings, { ICO_Grid: SettingsGrid, ICO_Section: CollapsibleSection, ICO_Seg, ICO_Switch, ICO_Slider, ICO_Color: ColorField, ICO_Reset: ResetButton, ICO_Preview });
