...
import { ColorField, CollapsibleSection, SEG_PROPS, visibleWhen, SegmentedGroup } from '@tuanla90/shared';
...
// from @tuanla90/shared above — the kit const is byte-identical to the former local one.
