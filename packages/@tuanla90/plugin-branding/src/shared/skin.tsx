...
/**
 * @tuanla90/plugin-branding — admin skin builder. A visual settings page produces a SkinCfg (per-section
...
export function buildSkinCss(cfg: SkinCfg): string {
  ...
  if (ct?.on && ct.from) {
    ...
    // inline border — e.g. the @tuanla90 settings-page container); only the class-less/hashed wrapper divs
