...
/**
 * @tuanla90/plugin-icon-remap — override NocoBase's built-in Ant Design icons with Lucide icons.
 *
 ...
 * registry at render time — so it doesn't matter whether the Lucide provider (@tuanla90/plugin-custom-icons)
