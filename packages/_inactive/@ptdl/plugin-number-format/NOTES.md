# @ptdl/plugin-number-format — research notes
...
**Status: WIP.** Extracted out of `@ptdl/plugin-icon-kit` on 2026-07-08 so it can be researched separately. NOT built/installed yet.
