...
| **P2 (GAP còn lại)** | Chữ ký (signature pad) · ghi âm (MediaRecorder → attachment) · reverse geocode (`address` qua Nominatim) · A2 mở-record/tạo-mới (hiện mới cart/filter/toast) · NFC/Web-Share/offline. | cắt nhỏ theo nhu cầu |
