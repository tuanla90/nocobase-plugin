# Mẫu trang hướng dẫn người dùng (User Guide) cho plugin @tuanla90
...
`nb-local/node_modules/@tuanla90/plugin-<x>/README.vi-VN.md` **và** `nb-local/storage/plugins/@tuanla90/plugin-<x>/README.vi-VN.md`.
...
## Quy ước viết
- **Song ngữ bắt buộc** (theo chuẩn @tuanla90): luôn có `README.vi-VN.md` **và** `README.md`.
