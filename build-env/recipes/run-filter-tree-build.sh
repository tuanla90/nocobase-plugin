...
PKG="@tuanla90/plugin-filter-tree"
echo "node: $(node -v)"
SRC="$ROOT/../packages/@tuanla90/plugin-filter-tree"
DST="$ROOT/packages/plugins/@tuanla90/plugin-filter-tree"
...
echo "=== TAR OUTPUT ==="
find "$ROOT/storage/tar" -type f -name "*filter-tree*" 2>/dev/null || true
