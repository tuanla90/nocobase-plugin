...
1. Admin NocoBase → **Plugin manager → Add → URL** → dán:
   `https://raw.githubusercontent.com/tuanla90/nocobase-plugin/main/latest/@tuanla90/plugin-hub-0.1.4.tgz`
   → Install → **Enable**.
...
| hub | 0.1.4 | `https://raw.githubusercontent.com/tuanla90/nocobase-plugin/main/latest/@tuanla90/plugin-hub-0.1.4.tgz` |
